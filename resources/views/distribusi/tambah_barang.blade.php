                ...
                <div class="card-body">
                    <form method="POST" action="" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input id="foto_barang" type="file" class="form-control-file" name="foto_barang" required>
                        </div>

                        <div class="form-group">
                            <label for="kategori_barang">Kategori Barang</label>
                            <select id="kategori_barang" class="form-control" name="kategori_barang" required>
                                <option value="Gacoan">Mie Gacoan</option>
                                <option value="Hompimpa">Mie Hompimpa</option>
