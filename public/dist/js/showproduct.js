document.addEventListener("DOMContentLoaded", function () {
    ...
    async function placeOrder() {
        ...
        try {
            ...
            const selectedMetodePembayaran = document.querySelector(
    ...
    async function fetchRiwayatTransaksi() {
        try {
            ...
            data.forEach((transaksi) => {
                let barangList;
                try {
                    barangList = JSON.parse(transaksi.barang);
                } catch (e) {
                    console.error("Error parsing barang field:", e);
                    return;
                }
    ...
    document
        .getElementById("closeNotaOverlay")
